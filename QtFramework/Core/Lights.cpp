...
// directional light
DirectionalLight::DirectionalLight(GLenum              light_index,
...
void DirectionalLight::Enable() { glEnable(_light_index); }

void DirectionalLight::Disable() { glDisable(_light_index); }

// point light
PointLight::PointLight(GLenum light_index, const HCoordinate3 &position,
                       const Color4 &ambient_intensity,
                       const Color4 &diffuse_intensity,
                       const Color4 &specular_intensity,
                       GLfloat constant_attenuation, GLfloat linear_attenuation,
                       GLfloat quadratic_attenuation)
    :

    DirectionalLight(light_index, position, ambient_intensity,
...
// spotlight
Spotlight::Spotlight(GLenum light_index, const HCoordinate3 &position,
                     const Color4 &ambient_intensity,
                     const Color4 &diffuse_intensity,
                     const Color4 &specular_intensity,
                     GLfloat constant_attenuation, GLfloat linear_attenuation,
                     GLfloat             quadratic_attenuation,
                     const HCoordinate3 &spot_direction, GLfloat spot_cutoff,
                     GLfloat spot_exponent)
    : PointLight(light_index, position, ambient_intensity, diffuse_intensity,
                 specular_intensity, constant_attenuation, linear_attenuation,
