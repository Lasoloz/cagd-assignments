...
public:
    Material(const Color4 &front_ambient   = Color4(),
    ...
    GLvoid SetAmbientColor(GLenum face, GLfloat r, GLfloat g, GLfloat b,
                           GLfloat a = 1.0f);

    // homework
    GLvoid SetDiffuseColor(GLenum face, const Color4 &c);
    GLvoid SetDiffuseColor(GLenum face, GLfloat r, GLfloat g, GLfloat b,
                           GLfloat a = 1.0f);

    // homework
    GLvoid SetSpecularColor(GLenum face, const Color4 &c);
    GLvoid SetSpecularColor(GLenum face, GLfloat r, GLfloat g, GLfloat b,
                            GLfloat a = 1.0f);

    // homework
    GLvoid SetEmissiveColor(GLenum face, const Color4 &c);
    GLvoid SetEmissiveColor(GLenum face, GLfloat r, GLfloat g, GLfloat b,
                            GLfloat a = 1.0f);
...
extern Material MatFBBrass, MatFBGold, MatFBSilver, MatFBEmerald, MatFBPearl,
    MatFBRuby, MatFBTurquoise;
} // namespace cagd
