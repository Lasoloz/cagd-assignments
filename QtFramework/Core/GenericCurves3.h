...
public:
    ...
    GenericCurve3(GLuint maximum_order_of_derivatives = 2,
                  GLuint point_count = 0, GLenum usage_flag = GL_STATIC_DRAW);

    // special constructor
    GenericCurve3(const Matrix<DCoordinate3> &derivative,
    ...
    GLfloat * MapDerivatives(GLuint order,
                             GLenum access_mode = GL_READ_ONLY) const;
    ...
    GLboolean SetDerivative(GLuint order, GLuint index, GLdouble x, GLdouble y,
                            GLdouble z = 0.0);
    GLboolean SetDerivative(GLuint order, GLuint index, const DCoordinate3 &d);
    GLboolean GetDerivative(GLuint order, GLuint index, GLdouble &x,
