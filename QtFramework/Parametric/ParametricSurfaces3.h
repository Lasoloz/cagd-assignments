...
{
public:
    // function pointer definition to the zeroth, first or higher order partial
    // derivatives of the parametric surface
...
public:
    // special constructor
    ParametricSurface3(const TriangularMatrix<PartialDerivative> &pd,
                       GLdouble u_min, GLdouble u_max, GLdouble v_min,
                       GLdouble v_max);
