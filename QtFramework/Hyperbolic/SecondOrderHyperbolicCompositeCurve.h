...
namespace cagd
{
    ...
    protected:
        ...
        GLboolean preserveConstraints(ArcAttributes& arc, GLuint controlPointIndex, DCoordinate3 newValue);
    ...
    public:
        ...
        GLboolean setSelectedColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f);
        GLboolean setCurveColor(GLuint index, GLuint controlPoint, GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f);
    };
}
